...
const eventApp = {
    ...
    _renderRiders() {
        ...
        const searchQuery = (document.getElementById('rider-search')?.value || '').trim().toLowerCase();
            ...
            <div class="glass-panel rounded-xl p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" id="rider-search" value="${searchQuery}" onkeyup="if(event.key==='Enter') eventApp._refreshRiders()" placeholder="라이더 검색..." class="border rounded-lg px-3 py-1.5 text-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none w-32 md:w-48">
                        ...
                        <button onclick="eventApp._refreshRiders()" class="bg-indigo-500 text-white px-3 py-1.5 rounded-lg text-sm font-bold hover:bg-indigo-600 transition-colors">검색</button>
                    </div>
                </div>
